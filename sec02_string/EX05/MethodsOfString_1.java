...
public class MethodsOfString_1 {
  public static void main(String[] args) {
    ...
    System.out.println(str2.length());  // length : 한글,영문 구분 없이 한 문자당 1개의 크기를 가짐.
    System.out.println();

    // 문자열 검색
    // @charAt()
    // 한글,영문 구분 없이 인덱스(x) 위치의 문자
    ...
    // @indexOf(), lastIndexOf()
    System.out.println(str1.indexOf('a'));  // indexOf : 앞에서부터 첫번째'a'가 위치한 인덱스
    System.out.println(str1.lastIndexOf('a'));  // lastIndexOf : 뒤에서부터 첫번째'a'가 위치한 인덱스
